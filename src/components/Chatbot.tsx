      ...
      if (messages.length === 0) {
        setTimeout(() => {
          const welcomeMessage: Message = {
            id: 'welcome',
            content: "Hi! I'm Shauraya's AI assistant. Ask me anything about his background, projects, or experience!",
            sender: 'bot',
            timestamp: new Date()
          };
          ...
          <Card className="h-full flex flex-col bg-card/95 backdrop-blur-sm border-border/50 shadow-2xl">
            ...
            <div className="flex items-center justify-between p-4 border-b border-border/50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-mono font-semibold text-foreground">Ask About Shauraya</h3>
            ...
            <div className="p-4 border-t border-border/50">
              <div className="flex space-x-2">
                <Input
                  ...
                  placeholder="Ask about Shauraya..."
              ...
              <p className="text-xs text-muted-foreground mt-2 font-mono">
                Try asking: "Tell me about his projects" or "What's his experience?"
              </p>
            </div>
          </Card>
        </motion.div>
